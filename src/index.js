...
import AdminDashboard from './pages/AdminDashboard/AdminDashboard'; // Import the AdminDashboard component
  ...
  <BrowserRouter>
    <Provider store={store}>
      <Routes>
        ...
        <Route path="/admin" element={<AdminDashboard />} /> {/* Update this line */}
